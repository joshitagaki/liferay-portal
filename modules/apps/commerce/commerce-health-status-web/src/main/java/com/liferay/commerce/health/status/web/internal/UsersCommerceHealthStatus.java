...
public class UsersCommerceHealthStatus implements CommerceHealthStatus {
	...
	public boolean isFixed(long companyId, long commerceChannelId)
		...
		return _commerceUserRoleHelper.hasCommerceUserPermissions(companyId);
	}
	...
	@Reference
	private CommerceUserRoleHelper _commerceUserRoleHelper;
	...
	private class UserRoleCallable implements Callable<Object> {
		...
		public Object call() throws Exception {
			_commerceUserRoleHelper.checkCommerceUserRoles(_serviceContext);
